...
<div id="footer">
	<div id="left">
		<div class="btn-group" style="margin-left: 20px; margin-right: 20px">
			<? echo "<a href=\"http".(empty($_SERVER['HTTPS'])?'':'s')."://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/tablet/index.php\"><button type=\"button\" class=\"btn btn-custom\">"; ?>
	...
	<div id="right">
		<div class="btn-group" style="margin-right: 20px;">
			<? echo "<a href=\"http".(empty($_SERVER['HTTPS'])?'':'s')."://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/tablet/includes/pupnp/index.php\"><button type=\"button\" class=\"btn btn-custom\">"; ?>
				Musik
			</button></a>
		</div>
		<div class="btn-group" style="margin-right: 20px">
			<? echo "<a href=\"http".(empty($_SERVER['HTTPS'])?'':'s')."://".$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/tablet/weather.php\"><button type=\"button\" class=\"btn btn-custom\">"; ?>
				Wetter
			</button></a>
		</div>
	</div>
