...
else if(basename($_SERVER['SCRIPT_NAME']) == "room.php") {
	if (isset($_GET['room'])) {
...
else if(basename($_SERVER['SCRIPT_NAME']) == "dtype.php") {
	if (isset($_GET['dtype'])) {
...
else if(basename($_SERVER['SCRIPT_NAME']) == "webcam.php") {
	$connstate = "disconnected";
...
<div id="titlebar">
	<div id="left">
		<div id="status" class="<? echo $connstate; ?>">&nbsp;</div>
		<div id="date"><? echo $date; ?></div>
		<div id="time"><? echo $clock." Uhr"; ?></div>
	</div>
	<div id="middle">
