...
<script language="javascript">
    $(document).ready(function () {
        $("#weather").load("../../helper-client/datacontroller.php?cmd=refresh_weather_for_header&relPath=../../../");
        var refreshId = setInterval(function () {
            $("#weather").load('../../helper-client/datacontroller.php?cmd=refresh_weather_for_header&relPath=../../../&' + 1*new Date());
        }, 200000);
    });
</script>
<?php } else {?>
<script language="javascript">
    $(document).ready(function () {
        $("#weather").load("./helper-client/datacontroller.php?cmd=refresh_weather_for_header");
        var refreshId = setInterval(function () {
            $("#weather").load('./helper-client/datacontroller.php?cmd=refresh_weather_for_header&' + 1*new Date());
        }, 200000);
    });
</script>
<?php } ?>
