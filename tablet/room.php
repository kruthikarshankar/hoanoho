                    ...
                    <div class="flipper">
                        <div class="front">
                            <div id="boxitem" class="<?php echo $class;?>">
                                <div id="title"><?php echo utf8_encode($device->name); ?></div><div id="pages"><?php echo ($hasbackside == true ? "1/2" : "&nbsp;"); ?></div>
                        ...
                        <div class="back">
                            <div id="boxitem" class="<?php echo $class; ?>">
                                <div id="title"><?php echo utf8_encode($device->name); ?></div><div id="pages"><?php echo ($hasbackside == true ? "2/2" : "&nbsp;"); ?></div>
