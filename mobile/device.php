...
<html>
	<head>
		...
		<title><? echo $__CONFIG['main_sitetitle'] . " - " . utf8_encode($device->name); ?></title>
	</head>
	<body>
		<header class="bar-title">
			...
			?>
	    	<a href="#devicedetails"><h1 class="title"><? echo utf8_encode($device->name); ?></h1></a>
	  	</header>
	  	...
	  	<div class="content">
			...
			<?
				...
				else if(utf8_encode($device->basetype) == "Temperaturregelung")
		    	{
	    			echo "<ul class=\"list inset\">";
		    	...
		    	else if(utf8_encode($device->basetype) == "Webcam")
		    	{
		    		echo "<ul class=\"list inset\">";
		    	...
		    	else if(utf8_encode($device->basetype) == "Jalousie")
		    	{
	    			echo "<ul class=\"list inset\">";
		    	...
		    	else if (utf8_encode($device->basetype) == "Tuer/Fenster-Kontakt")
		    	{
	    			echo "<ul class=\"list inset\">";
