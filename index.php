...
<body>
	...
	<section class="board">
		...
		<form method="POST" enctype="multipart/form-data" name="newNoteForm" id="newNoteForm">
			<div class="note_<? echo $current_notecolor; ?>" style="-webkit-transform:rotate(-3deg); margin-top: 20px;" id="newnote">
				<div id="pin5"></div>
				<div id="title"><input type="text" id="notetitle"></div>
				<div id="content"><textarea id="notecontent"></textarea></div>
				<div id="footer"><? generateNoteColors(); ?><div id="savenote" title="Notiz veröffentlichen">&nbsp;</div><div id="savingnote" title="Notiz veröffentlichen" style="display:none;">&nbsp;</div></div>
				<input type="hidden" name="papercolor" id="papercolor" value="<? echo $current_notecolor; ?>">
			</div>
		</form>
		...
		?>
				<div class="note_<? echo $note->papercolor; ?>" style="-webkit-transform:rotate(<? echo $rotation_note; ?>deg); margin-top:<? echo $margin_note; ?>px" id="note-<? echo $note->no_id; ?>">
					<div id="pin<? echo $pin; ?>" style="-webkit-transform:rotate(<? echo $rotation_pin; ?>deg);"></div>
					<div class="closenote" id="closenote-<? echo $note->no_id; ?>"></div>
					<div id="title"><? echo $note->title; ?></div>
					<div id="content"><? echo $note->content; ?></div>
					<div id="footer"><? echo $note->username . " am " . $note->create_date . " um " . $note->create_time; ?></div>
				</div>
		<?
		}
		?>
		...
		<div id="page_right">
			<div class="paper_yellow" id="page">
				...
				<div id="block">
					...
					{
					?>
					<div id="text"><a href="<? echo $link->url; ?>" target="_blank"><? echo $link->name; ?></a></div>
					<? } ?>
				</div>
				<div id="block_last">&nbsp;</div>
			</div>
