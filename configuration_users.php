...
<html>
	<head>
		...
		<title><? echo $__CONFIG['main_sitetitle'] ?> - Einstellungen - Benutzer</title>
...
<body>
	...
	<section class="main_configuration">
		...
		?>
			<div class="listitem" id="listitem-<? echo $user->uid; ?>">
				<div id="username"><input type="text" name="username" value="<? echo $user->username; ?>"></div>
				<div id="password"><input type="password" name="password"></div>
				<div id="group"><? displayUserGroup($user->gid); ?></div>
				<div id="action">
					<a href="javascript:copyToClipboard('<? echo $pageURL."/login.php?login=".$user->hash; ?>')" title="Quick Login"><img src="./img/quicklogin.png"></a>
					<a class="saveuserbutton" id="saveuserbutton-<? echo $user->uid; ?>" href="#" title="Änderungen speichern"><img src="./img/save.png"></a>&nbsp;
					<a class="deleteuserbutton" id="deleteuserbutton-<? echo $user->uid; ?>" href="#" title="Benutzer löschen"><img src="./img/delete.png"></a>
				</div>
			</div>
		<?
		}
