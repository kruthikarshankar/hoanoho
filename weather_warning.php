...
<body>
    ...
    <section class="main_weather">
        <h1><span>Wetter (Unwetter-) Warnungen</span></h1>
            <div id="radar"><a href="http://www.dwd.de/bvbw/appmanager/bvbw/dwdwwwDesktop?_nfpb=true&_windowLabel=T14600649251144330032285&_urlType=action&MAP_VIEW=true&SHOW_TIME_SEL=true&STATIC_CONTENT_VIEW=false&WARNING_TYPE=0&LAND_CODE=<?= $__CONFIG['dwd_state'] ?>" target="_blank"><img src="http://www.dwd.de/dyn/app/ws/maps/<?= $__CONFIG['dwd_state'] ?>_x_x_0.gif"></a></div>
