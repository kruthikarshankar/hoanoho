...
<?
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "editplan") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "deleteplan") {
...
<html>
	<head>
		...
		<title><? echo $__CONFIG['main_sitetitle'] ?> - Einstellungen - Zeitplaner</title>
	</head>
<body>
	...
	<section class="main_configuration_scheduler">
		...
		<div id="listitem">
			...
			<div id="action">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="javascript:document.deletePlanForm<? echo $scheduler->sch_id; ?>.submit()" title="Zeitplan löschen" onclick="javascript:return confirm('Soll der Zeitplan wirklich gelöscht werden ?');"><img src="./img/delete.png"></a>
			</div>
		</div>
		<?
