<?
	...
	if(isset($_POST['cmd']) && $_POST['cmd'] == "adddevice") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "editdevice") {
		$isStructure = "";
		$isHidden = "";
		...
		$url = "http://".$_SERVER['HTTP_HOST']."/includes/sendMessageToSocketServer.php?command=\"update_device\"&message=\"".$_POST['dev_id']."\"";
		$curl = curl_init();
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "deletedevice") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "addtype") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "edittype") {
		$off_imageid = 0;
		$on_imageid = 0;
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "deletetype") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "addroom") {
		$sql = "INSERT INTO rooms (name) values ('".utf8_decode("Neuer Raum")."')";
		mysql_query($sql);
	}
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "editroom") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "deleteroom") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "addfloor") {
		$sql = "INSERT INTO device_floors (name,position) values ('".utf8_decode("Neue Ebene")."',0)";
		mysql_query($sql);
	}
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "editfloor") {
	...
	else if(isset($_POST['cmd']) && $_POST['cmd'] == "deletefloor") {
...
<body>
	...
	var evt         = new Event(),
	    ...
	    <? print($jsdragdevices_def); ?>

	 <? print($jsdragdevices_act); ?>	
	</script>
</body>
</html>